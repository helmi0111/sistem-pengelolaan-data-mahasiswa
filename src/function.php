...
function tambah($data)
{
    ...
    $sql = "INSERT INTO mahasiswa VALUES ('$nim','$nama','$tmpt_Lahir','$tgl_Lahir','$jekel','$prodi','$semester','$kelas','$tahun_angkatan','$email','$gambar','$alamat')";
...
function ubah($data)
{
    ...
    $sql = "UPDATE mahasiswa SET nama = '$nama', tmpt_Lahir = '$tmpt_Lahir', tgl_Lahir = '$tgl_Lahir', jekel = '$jekel', prodi = '$prodi', semester = '$semester', kelas = '$kelas', tahun_angkatan = '$tahun_angkatan', email = '$email', gambar = '$gambar', alamat = '$alamat' WHERE nim = $nim";
