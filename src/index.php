                    ...
                    <tbody>
                        ...
                        <?php foreach ($mahasiswa as $row) : ?>
                            <tr>
                                ...
                                <td>
                                    <button class="btn btn-success btn-sm text-white detail" data-id="<?= $row['nim']; ?>" style="font-weight: 600;"><i class="bi bi-info-circle-fill"></i>&nbsp;</button> |

                                    <a href="ubah.php?nim=<?= $row['nim']; ?>" class="btn btn-warning btn-sm" style="font-weight: 600;"><i class="bi bi-pencil-square"></i>&nbsp;</a> |

                                    <a href="hapus.php?nim=<?= $row['nim']; ?>" class="btn btn-danger btn-sm" style="font-weight: 600;" onclick="return confirm('Apakah anda yakin ingin menghapus data <?= $row['nama']; ?> ?');"><i class="bi bi-trash-fill"></i>&nbsp;</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
